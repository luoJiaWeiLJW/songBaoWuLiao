...
class AdvancedSearchForm extends React.Component {
  ...
  getFields = () => {
    ...
    if (keys) {
      ...
      children.push(
        <Col xl={4} lg={24} style={{textAlign: 'right',float:'right',marginRight:'450px'}} key="btn">
          <Button type="primary" htmlType="submit" style={{marginRight:'30px'}}>搜索</Button>
  ...
  render() {
    return (
      ...
      >
        <Row gutter={16} style={{marginTop:'15px',marginLeft:'340px'}}>
          {this.getFields()}
        </Row>
      </Form>
    );
