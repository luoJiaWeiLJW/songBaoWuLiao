...
class ModalForm extends Component {
                ...
                this.props.form.setFields({
                   code: {
                    ...
                    name: {
                        ...
                        value:res.data.data.categoryId,
                    },model: {
                        value:res.data.data.model,
                    },unit: {
                        value:res.data.data.unit,
                    },common: {
                        value:res.data.data.common,
                    },source: {
                        value:res.data.data.source,
                    },processing: {
                        value:res.data.data.processing,
                    },seriesId: {
                        value:res.data.data.seriesId,
                    },color: {
                        value:res.data.data.color,
                    },expirationType: {
                        value:res.data.data.expirationType,
                    },storage: {
                        value:res.data.data.storage,
                    },origin: {
                        value:res.data.data.origin,
                    },level: {
                        value:res.data.data.level,
                    },semiType: {
                        value:res.data.data.semiType,
                    },oilPaint: {
                        value:res.data.data.oilPaint,
                    },note: {
                        value:res.data.data.note,
                    }
                });
    ...
    render() {
            ...
            if(this.props.statusNumber==="0"){
                FormItems.push(
                    <Col xs={24} key={'add'} style={{textAlign: 'center'}}>
                      <Button onClick={this.handleSubmit1}>保存</Button>&nbsp;&nbsp;
        ...
        // console.log(codeData,"1321311321")
        ...
        return (
            ...
            ><div className="TitleTop">
              ...
              >
                ...
                <Button className="Sure1" onClick={this.changeCode1}>确定</Button>
            </div>
              <Form>
                <Row gutter={40}>
                    {FormItems}
