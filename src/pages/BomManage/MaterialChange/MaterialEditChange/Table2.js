...
class Table2 extends Component{
    ...
    showModal = (type,record) => {
        ...
        const {modalData,modalData1} = this.state ;
        Object.keys(modalData).forEach(key=>{
            axios({
                ...
                this.setState({
                    modalData1:res.data.data,
                })
                modalData[key].value =this.state.modalData1[key];
            })
    ...
    render = () => {
        ...
        return (
            <div style={{textAlign:'left'}}>
                ...
                <ModalForm2 bindRecord={this.state.record}  modalType={this.state.modalType}  visible={this.state.visible} onOk={this.handleOk} onCancel={this.handleCancel}  modalData={this.state.modalData}
                 modalData1={this.state.modalData1}
